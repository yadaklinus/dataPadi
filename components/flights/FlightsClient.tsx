...
import { requestFlight } from '@/app/actions/flight';
...
export default function FlightsClient({ initialAirports }: FlightsClientProps) {
    ...
    const safeAirports = Array.isArray(initialAirports) ? initialAirports : [];
                        ...
                        <div className="space-y-4 relative">
                            <div className="relative group z-20">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full h-14 pl-12 pr-4 bg-slate-50/50 border border-slate-200 rounded-2xl focus:bg-white focus:border-slate-800 focus:ring-1 focus:ring-slate-800 outline-none text-base font-semibold tracking-wide placeholder:text-slate-300 placeholder:font-medium transition-all uppercase"
                                />
                            ...
                            <div className="relative group z-10">
                                ...
                                <input
                                    type="text"
                                    placeholder="Destination (e.g., ABV)"
                                    value={destination}
                                    onChange={(e) => {
