...
import { Home, Printer, Clock, User, Plane, LucideIcon } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { icon: Plane, label: 'Flights', route: '/user/flights' },
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                */}
                <div className={`absolute inset-0 rounded-2xl transition-all duration-400 ease-[cubic-bezier(0.23,1,0.32,1)] ${isActive
                ...
                <div className="relative z-20 transition-transform duration-300 group-active:scale-90 flex flex-col items-center">
                  <Icon
                    ...
                    className={`transition-colors duration-300 ${isActive ? 'text-blue-600' : 'text-slate-500 group-hover:text-blue-500'
                      }`}
                  />
                  <span className={`text-[10px] font-bold mt-1 transition-colors duration-300 ${isActive ? 'text-blue-600' : 'text-slate-500 group-hover:text-blue-500'
                    }`}>
                    {item.label}
                  </span>
                </div>
